...
public class T0Viewer implements IDataEventListener, DetectorListener, ActionListener, ChangeListener {
	...
	mainPanel.setLayout(new BorderLayout());
        ...
        //splitpane.setBottomComponent(monitors[0].getCcview());//commented out by Hamza as I only want to see T0 calibraiton
        ...
        for(int k =1; k<this.monitors.length; k++) {
...
//        System.out.println("Time to update ...");
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        JFrame frame = new JFrame("ALERT DC Calibration");
